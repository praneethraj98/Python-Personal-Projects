...
def totalCoronaCasesByState(selection):
    ...
    print('Total Infected: ' +
          str(data['regionData'][finalSelection]['totalInfected']))
    print('New Infected: ' +
          str(data['regionData'][finalSelection]['newInfected']))
    print('Recovered: ' + str(data['regionData'][finalSelection]['recovered']))
    print('New Recovered: ' +
          str(data['regionData'][finalSelection]['newRecovered']))
    print('Deceased: ' + str(data['regionData'][finalSelection]['deceased']))
    print('New Deceased: ' +
          str(data['regionData'][finalSelection]['newDeceased']))
